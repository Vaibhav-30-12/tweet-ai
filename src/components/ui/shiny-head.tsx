  ...
  ({ children, className, ...props }, ref) => {
    return (
      <motion.h1
        ref={ref}
        className={cn(
          "relative text-center text-4xl md:text-5xl font-bold tracking-tight py- bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500",
          className
        )}
        {...animationProps}
        {...props}
